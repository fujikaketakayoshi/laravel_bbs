...
// can:adminユーザーのみ可、Policyで制御
Route::group(['middleware' => ['auth']], function() {
	Route::get('/admin/index', [App\Http\Controllers\AdminController::class, 'index'])->name('admin.index');
	Route::delete('/admin/thread_delete/{thread}', [App\Http\Controllers\AdminController::class, 'thread_delete'])->name('admin.thread_delete');
	Route::delete('/admin/reply_delete/{reply}', [App\Http\Controllers\AdminController::class, 'reply_delete'])->name('admin.reply_delete');	
});
